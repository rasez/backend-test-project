...
After your interview, we would like to send you a test task to check your code level and task understanding.

There is no strict deadline for this task, so we will take into consideration delivery time / code level / task functionality / UX
...
To be able to log in the user has to verify his/her account from the email he/she gets. [model observe]
